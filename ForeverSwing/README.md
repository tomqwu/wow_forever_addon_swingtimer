...
## Standalone hunter addon

Version 0.3.1 removes the hunter indicator added in 0.3.0. Hunter range belongs
to the separate ForeverHunterRange addon, with its own frame, settings, and
`/fhrange` commands. ForeverSwing remains a melee swing timer.
