...
- Out-of-range dimming and an optional personal timing cue
...
abilities. `/fswing cue 0.4` adds a personal marker; `/fswing cue 0` disables it.

[Full commands, API research, sources and limitations](ForeverSwing/README.md)

## Validation

Lua syntax checks and 37 model/mock-client checks pass. Live in-game combat,
